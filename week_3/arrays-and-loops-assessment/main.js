...
console.assert(
  arrayReverser(numbers).toString() === "6,5,101,3,11,7,9,18,4,12,1",
...
console.assert(
  joinArrays([numbers, numbersTwo]).toString() ===
    "1,12,4,18,9,7,11,3,101,5,6,33,56,72,2,5,66,90,21,42",
  {
    message:
      'joinArrays should return "1,12,4,18,9,7,11,3,101,5,6,33,56,72,2,5,66,90,21,42"'
  }
);
